...
/**
 * This is thrown when something is bought that doesn't have a reciever.
 * In this context means the build area for energysources or the house for energy consumers.
